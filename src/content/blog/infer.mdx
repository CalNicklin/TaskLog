...
# Overview
This project demonstrates building a modern, type-safe SDK for machine learning inference operations, complete with a Next.js dashboard for API key management and usage monitoring. The project uses a monorepo structure with Turborepo, combining a Next.js frontend, Hono-based API, and a Node.js SDK package.
